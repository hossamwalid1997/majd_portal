...
class HrAdminCopyCenter(models.Model):
    ...
    state = fields.Selection([('draft', 'Draft'), ('confirm', 'Waiting Approval'), ('validate', 'Approved'),
                              ...
                              ('refuse', 'Refused')], 'State', tracking=True, default='draft')
    ...
    def action_confirm(self):
        ...
        if not self.product_ids:
            raise UserError(_("Please add Copy Details first !"))
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body='Request For Copy Confirmed.')
        self.state = 'confirm'
    ...
    def action_inprogress(self):
        ...
        """
        self.ensure_one()
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body='Request For Copy Is In Progress.')
    ...
    def action_refuse(self):
        ...
        """
        self.ensure_one()
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body='Request For Copy Refused.')
        self.state = 'refuse'
    ...
    def action_set_draft(self):
        ...
        """
        self.ensure_one()
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body='Request For Copy Set To Draft.')
        self.state = 'draft'
    ...
    def action_done(self):
        ...
        """
        self.ensure_one()
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body='Request For Copy Is Done.')
        self.write({'state': 'done',
                    'expense_total': self.amount_total})
    ...
    def action_validate(self):
        ...
        partner_ids = admin_groups_ids and [employee.user_id.partner_id.id for employee in admin_groups_ids.admin_ids if employee.user_id] or []
        self.sudo().message_subscribe(partner_ids=partner_ids)
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body='Request For Copy Is Approved.')
    ...
    def generate_expense(self):
        ...
        """
        self.ensure_one()
        product_id = self.env.ref('saudi_hr_copy_center.copy_center')
