...
class TransferEmployee(models.Model):
    ...
    def onchange_employee(self):
        ...
        """
        res = super(TransferEmployee, self).onchange_employee()
    ...
    def get_employee_data(self, employee_id, contract=False):
        ...
        """
        res = super(TransferEmployee, self).get_employee_data(employee_id, contract)
        if contract:
    ...
    def set_to_draft(self):
        ...
        """
        self.ensure_one()
        res = super(TransferEmployee, self).set_to_draft()
