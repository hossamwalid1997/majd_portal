...
class ManpowerPlan(models.Model):
    ...
    def action_confirm_manpower(self):
        ...
        self.ensure_one()
        self.state = 'confirm'
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body=_('Manpower plan confirm'))
    ...
    def action_approve_manpower(self):
        ...
        self.ensure_one()
        self.state = 'approved'
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body=_('Manpower plan approve.'))
    ...
    def action_reject_manpower(self):
        ...
        self.ensure_one()
        self.state = 'rejected'
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body=_('Manpower plan reject'))
    ...
    def action_set_draft(self):
        ...
        self.ensure_one()
        self.state = 'draft'
        self.message_post(message_type="email", subtype_xmlid='mail.mt_comment', body=_('Manpower plan draft'))

    def unlink(self):
        for rec in self:
            if rec.state not in ['draft', 'rejected']:
                raise UserError(_('you can not delete record when stage is %s.')%rec.state)
