...
class HrPayslip(models.Model):
    ...
    loan_schedule_id = fields.Many2one('hr.employee.loan.line', string="Loan Schedule", copy=False)
        ...
        for payslip in self:
            ...
            if rule_ids:
                ...
                for loan in loan_ids:
                    ...
                    loan_schedule_id = loan.loan_lines.filtered(lambda l: l.date >= payslip.date_from and l.date <= payslip.date_to and l.state == 'draft' and not l.payslip_id)
                    if loan_schedule_id:
