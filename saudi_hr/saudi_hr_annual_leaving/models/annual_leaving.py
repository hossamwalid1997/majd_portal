...
class LeavesDetails(models.Model):
    ...
    @api.depends('year_id', 'year_id.date_start', 'year_id.date_stop')
    ...
    remaining_leaves = fields.Float(string='Remaining Leaves', compute='compute_remaining_leaves', compute_sudo=True)
