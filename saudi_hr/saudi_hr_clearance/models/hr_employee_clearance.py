...
class HrEmployeeClearance(models.Model):
    ...
    location = fields.Many2one('hr.branch', 'Location', readonly="True", related='employee_id.branch_id', store=True)
    ...
    # employee_dept = fields.Boolean('Employee Department', default=False, tracking=True)
    # it_dept = fields.Boolean('IT Department', default=False, tracking=True)
    # hr_dept = fields.Boolean('HR Department', default=False, tracking=True)
    # finance_dept = fields.Boolean('Finance Department', default=False, tracking=True)
    ...
    def write(self, vals):
        for rec in self:
            if (vals.get('admin_dept_ids') or vals.get('finance_dept_ids') or vals.get('employee_dept_ids'))\
                ...
                raise UserError(_("You are not modify departments data please contact your administrator."))
    ...
    def set_to_draft(self):
        ...
        self.ensure_one()
        self.state = 'draft'
        self.admin_dept_ids = [(5, 0)]
        self.finance_dept_ids = [(5, 0)]
        self.employee_dept_ids = [(5, 0)]
