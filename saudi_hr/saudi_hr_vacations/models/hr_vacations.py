...
class HRVacation(models.Model):
    ...
    return_to_work_date = fields.Date(string='Return to Work Date', copy=False, tracking=True)
    vacation_days = fields.Float(string='No. of Vacation Days', compute='calculate_vacation_days',copy=False, tracking=True)
    ...
    direct_manager_approved_by = fields.Many2one('res.users', string='Direct Manager Approval By', tracking=True, copy=False)
    financial_manager_approved_by = fields.Many2one('res.users', string='Financial Manager Approval By', tracking=True, copy=False)
    hr_manager_approved_by = fields.Many2one('res.users', string='HR Manager Approval By', tracking=True, copy=False)
    cancelled_by = fields.Many2one('res.users', string='Cancelled By', tracking=True, copy=False)
    direct_manager_approved_date = fields.Datetime('Direct Manager Approved Date', tracking=True, copy=False)
    financial_manager_approved_date = fields.Datetime('Financial Manager Approved Date', tracking=True, copy=False)
    hr_manager_approved_date = fields.Datetime('HR Manager Approved Date', tracking=True, copy=False)
    ...
    state = fields.Selection([('draft', 'Draft'),
                              ...
                              ('cancel', 'Cancel')], string="Status", default='draft', copy=False, tracking=True)
