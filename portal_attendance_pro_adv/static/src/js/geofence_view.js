odoo.define('portal_attendance_pro_adv.GeofenceView', function (require) {
    'use strict';

    var BasicView = require('web.BasicView');
    var core = require('web.core');

    var GeofenceModel = require('portal_attendance_pro_adv.GeofenceModel');
    var GeofenceRenderer = require('portal_attendance_pro_adv.GeofenceRenderer');
    var GeofenceController = require('portal_attendance_pro_adv.GeofenceController');
