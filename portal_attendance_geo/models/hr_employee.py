...
class HrEmployee(models.Model):
    ...
    def attendance_manual(self, next_action, entered_pin=None, location=False, ip_address=False, geofence_ids=False,
                          photo_img64=False):
        res = super(HrEmployee, self.with_context(attendance_geolocation=location, attendance_ipaddress=ip_address,
                                                  attendance_geofence=geofence_ids,
                                                  attendance_photo=photo_img64)).attendance_manual(next_action,
                                                                                                   entered_pin)
        return res
