...
class HrAttendanceController(http.Controller):
    ...
    @http.route('/portal_attendance_geo/search_read/get_employee_data', type='json', auth='user', website=True)
...
class HrAttendancePortal(CustomerPortal):
    ...
    def portal_my_hr_attendances(self, page=1, date_begin=None, date_end=None, sortby=None, filterby=None, search=None,
        ...
        return request.render("portal_attendance_geo.portal_my_hr_attendances", values)
    ...
    def create_new_attendance(self, access_token=None):
        ...
        return request.render("portal_attendance_geo.my_attendance_create_new", values)
